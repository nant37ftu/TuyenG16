/* ============================================================
   NỘI DUNG TRANG — Ban tổ chức sửa chữ ở đây là trang tự đổi
   ============================================================ */
window.NOI_DUNG = {
  the_he: 'Gen 16',
  ...
  quy_tac_4t: [
    ...
    { chu: 'Trách nhiệm', y: 'Việc mình không xong thì đồng đội gánh. Nhận việc là nhận trách nhiệm.' },
    { chu: 'Tự giác', y: 'Không lề mề, không ỷ lại. Chủ động trước khi được nhắc.' },
    { chu: 'Tin tưởng', y: 'Tin tổ chức, tin đồng đội, tin vào chính mình.' }
  ],
